...
faqs_db = {
    "web": [
        ...
        {"q": "Is the website built to be Generative Engine Optimized (GEO)?", "a": "Yes, our web development process includes structuring content and data semantically to ensure it's easily digestible by AI search engines like ChatGPT, Google SGE, and Perplexity."}
    ],
    "seo": [
        ...
        {"q": "How do you optimize for Generative AI Search (AEO)?", "a": "Answer Engine Optimization (AEO) involves deeply structuring your content, implementing advanced FAQ and precise Semantic Schema Markup, and answering high-intent questions clearly so AI engines cite your site as a primary source."}
    ],
    "local": [
        ...
        {"q": "How do you analyze competitors in {LOCATION}?", "a": "We use advanced competitor gap analysis tools to dissect the exact keywords, citations, and backlink strategies your top competitors in {LOCATION} are using, allowing us to build a campaign that outranks them."}
    ],
    "ecom": [
        ...
        {"q": "How does GEO impact E-commerce sales?", "a": "Optimizing for AI Overviews ensures your products are recommended when users ask conversational questions like 'What is the best [product] for [use case]?', capturing highly qualified, ready-to-buy traffic."}
    ],
    "smm": [
    ...
    "general": [
        ...
        {"q": "How do you stay ahead of Google's AI Overviews and algorithm updates?", "a": "We employ cutting-edge Answer Engine Optimization (AEO) and rigorous competitor search analysis. This dual approach ensures your business not only ranks in traditional search but also acts as the primary cited source in AI-generated responses."}
    ]
}
...
print("faqs.json updated with GEO/AEO and competitor FAQs.")
